...
export default function CrimeHeatmap() {
    ...
    return (
        <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-4">
                <h2 className="text-lg font-semibold flex items-center mb-4">
                    <AlertTriangle className="w-5 h-5 mr-2 text-blue-900" />
                    Hotspot Analysis
                </h2>
                ...
                {selectedHotspot ? (
                    <div className="space-y-4">
                        <div className="p-4 bg-gray-50 rounded-lg">
                            <h3 className="text-xl font-semibold mb-2">{selectedHotspot.area}</h3>
                            <p className="text-gray-600">{selectedHotspot.location}</p>
                        </div>

                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-red-50 rounded-lg">
                                <span className="text-sm text-red-600">Crime Rate</span>
                                <p className="text-2xl font-bold text-red-700">{selectedHotspot.crimeRate}%</p>
                            </div>

                            <div className="p-4 bg-blue-50 rounded-lg">
                                <span className="text-sm text-blue-600">Recent Incidents</span>
                                <p className="text-2xl font-bold text-blue-700">{selectedHotspot.recentIncidents}</p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 border rounded-lg">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <span className={`flex items-center ${trendColors[selectedHotspot.trend]}`}>
