...
export default function CreatePersonModal({ onClose, onSubmit, type, isSubmitting, isRequest = false }: CreatePersonModalProps) {
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto dark:bg-gray-800 dark:text-gray-300">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-semibold">
                        {isRequest ? 
                            `Request to Add New ${type === 'suspect' ? 'Suspect' : 'Missing Person'}` :
                    ...
                    <div className="flex justify-end space-x-4 pt-4">
                        ...
                        >
                            {isSubmitting ? 'Processing...' : 
                                isRequest ? 'Submit Request' : 'Create'
                            }
                        </button>
                    </div>
                </form>
